...
def find_indices(primary_list, query_list):
    ...
    """
    # BOLT OPTIMIZATION: Replaced O(N^2) list.index() lookup with O(1) dictionary lookup.
    # Expected impact: Significantly faster performance when matching large lists of queries.
    lookup = {}
