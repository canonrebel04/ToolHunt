...
def find_indices(primary_list, query_list):
    ...
    """
    # ⚡ Bolt Optimization: Replace O(N * M) list.index() lookup with O(N + M) hash map lookup
    # Reduces complexity and prevents performance degradation as the database grows.
    mapping = {}
