...
def find_indices(primary_list, query_list):
    ...
    """
    # ⚡ Bolt: Replaced O(N*M) list.index() lookups with O(N+M) hash map
    # Expected impact: Improves search performance, particularly for large lists by reducing time complexity
    mapping = {}
