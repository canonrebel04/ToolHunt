...
def _load_tools():
    ...
    with _lock:
        ...
        # Assign _tools last to prevent race conditions during double-checked locking
        _tools = tools
...
def find_indices(primary_list, query_list):
    ...
    # Fast path for finding indices in the lazy-loaded descriptions using O(1) lookups
