...
def find_indices(primary_list, query_list):
    ...
    """
    indices = []
    # ⚡ Bolt: Replace O(N*M) list.index() lookups with O(N+M) hash map lookup
    # Expected impact: Significantly reduces CPU time when searching through many descriptions
    mapping = {}
