...
def find_indices(primary_list, query_list):
    ...
    """
    # ⚡ Bolt Optimization: Use dictionary lookup instead of list.index()
    # Performance impact: Reduces time complexity from O(N*M) to O(N+M)
    # by eliminating repeated linear scans of primary_list.
    lookup = {}
