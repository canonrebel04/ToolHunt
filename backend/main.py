...
def _load_tools():
    ...
    """
    global _tools, _descriptions, _descriptions_idx
    ...
    with _lock:
        ...
        for idx, item in enumerate(descriptions):
            if item not in descriptions_idx:
                descriptions_idx[item] = idx

        _tools = tools
        _descriptions = descriptions
        _descriptions_idx = descriptions_idx
