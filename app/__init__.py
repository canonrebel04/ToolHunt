...
def create_app(config_class=None):
    ...
    # SECURITY: Ensure SECRET_KEY is set in production without falling back to a default.
    if app.debug is False and app.config.get('TESTING') is False and (app.config.get('SECRET_KEY') == 'dev-fallback-key' or not app.config.get('SECRET_KEY')):
