...
def health():
    ...
    try:
        ...
        checks["database"] = {"status": "degraded", "error": "Service check failed"}
    ...
    try:
        ...
        checks["model"] = {"status": "degraded", "error": "Service check failed"}
        status["status"] = "degraded"
    ...
    try:
        ...
        checks["cache"] = {"status": "degraded", "error": "Service check failed"}
        if status["status"] == "ok":
            status["status"] = "degraded"
