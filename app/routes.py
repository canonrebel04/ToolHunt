...
def health():
    ...
    try:
        ...
        checks["database"] = {"status": "degraded", "error": "Internal database error"}
    ...
    try:
        ...
        checks["model"] = {"status": "degraded", "error": "Internal model error"}
        status["status"] = "degraded"
    ...
    try:
        ...
        checks["cache"] = {"status": "degraded", "error": "Internal cache error"}
        if status["status"] == "ok":
            status["status"] = "degraded"
