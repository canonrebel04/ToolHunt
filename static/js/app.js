    ...
    sortedTools.forEach((tool, index) => {
        ...
        toolCard.innerHTML = `
            ...
            <div class="card-footer">
                <a href="${tool.link || '#'}" target="_blank" class="tool-link" ${!tool.link ? 'style="opacity: 0.5; pointer-events: none;"' : ''} aria-label="${tool.link ? 'Access Tool: ' + (tool.name ? tool.name.replace(/"/g, '&quot;') : 'Unknown Tool') : 'No Link Available'}">
