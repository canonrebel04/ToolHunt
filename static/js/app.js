    ...
    sortedTools.forEach((tool, index) => {
        ...
        toolCard.innerHTML = `
            ...
            <div class="card-footer">
                ${tool.link
                    ? `<a href="${tool.link}" target="_blank" class="tool-link" aria-label="Access ${tool.name || 'tool'}">
                        <i class="fas fa-external-link-alt"></i> Access Tool
                       </a>`
                    : `<span class="tool-link" style="opacity: 0.5; cursor: not-allowed;" aria-disabled="true">
