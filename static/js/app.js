    ...
    sortedTools.forEach((tool, index) => {
        ...
        toolCard.innerHTML = `
            ...
            <div class="card-footer">
                <a ${tool.link ? `href="${tool.link}"` : ''} target="_blank" class="tool-link" ${!tool.link ? 'style="opacity: 0.5; pointer-events: none;" aria-disabled="true" tabindex="-1"' : 'rel="noopener noreferrer"'}>
