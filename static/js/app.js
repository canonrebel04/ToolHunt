    ...
    sortedTools.forEach((tool, index) => {
        ...
        toolCard.innerHTML = `
            ...
            <div class="card-footer">
                <a href="${tool.link || '#'}" target="_blank" class="tool-link" ${!tool.link ? 'style="opacity: 0.5; pointer-events: none;" aria-disabled="true" tabindex="-1"' : ''} aria-label="${tool.link ? 'Access ' + (tool.name || 'Tool') : 'No Link Available for ' + (tool.name || 'Tool')}">
