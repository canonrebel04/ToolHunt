    ...
    sortedTools.forEach((tool, index) => {
        ...
        toolCard.innerHTML = `
            ...
            <div class="card-footer">
                <a href="${tool.link || '#'}" target="_blank" rel="noopener noreferrer" class="tool-link" ${!tool.link ? 'style="opacity: 0.5; pointer-events: none;" aria-disabled="true" title="No link available for this tool"' : 'aria-label="Access ' + (tool.name || 'tool') + '" title="Open tool link in new tab"'}>
