    ...
    sortedTools.forEach((tool, index) => {
        ...
        toolCard.innerHTML = `
            ...
            <div class="card-footer">
                <a href="${tool.link || '#'}" target="_blank" class="tool-link" ${!tool.link ? 'style="opacity: 0.5; pointer-events: none;" tabindex="-1" aria-disabled="true"' : ''} aria-label="${tool.link ? 'Access Tool: ' + (tool.name || 'Unknown Tool') : 'No Link Available for ' + (tool.name || 'Unknown Tool')}">
